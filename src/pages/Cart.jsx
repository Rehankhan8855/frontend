...
import EmtyCart from "../assets/Images/emtycart.png";
import { FaTrashAlt } from "react-icons/fa";
import Model from "../components/Model";
import ChangeAddress from "../components/ChangeAddress";
import { decreseQuantity, inceraseQuantity, removeFromCart } from "../redux/cartSlice";
                  ...
                  >
                    ...
                    <div className="flex space-x-12 items-center">
                      ...
                      <div className="flex items-center justify-center border">
                        <button className="text-xl font-bold px-1.5 border-r" onClick={()=> dispatch(decreseQuantity(product.id))}>
                          -
                        </button>
                        <p className="text-xl px-2">{product.quantity}</p>
                        <button className="text-xl px-1 border-1" onClick={()=> dispatch(inceraseQuantity(product.id))}>+</button>
                      </div>
